# Generated by Powerlevel10k configuration wizard on 2025-10-25 at 20:38 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%013F'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%013F' #🭮 '
  ...
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰫮󰫿󰫰󰫵'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=015 #31
  ...
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION='%250F'
  # Custom prefix.
